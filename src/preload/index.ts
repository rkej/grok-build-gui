...
export type GrokDesktopApi = {
  ...
  prompt: (text: string, attachments?: readonly import("../shared/protocol").ComposerAttachment[], opts?: { deliverAs?: "steer" | "followUp" }) => Promise<void>;
  editQueuedMessage: (id: string, text: string, attachments?: readonly import("../shared/protocol").ComposerAttachment[]) => Promise<void>;
